...
class MainCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        photos.append(UIImage(named: "ii1")!)
        photos.append(UIImage(named: "ii2")!)
        photos.append(UIImage(named: "ii3")!)
        photos.append(UIImage(named: "ii9")!)
        photos.append(UIImage(named: "ii4")!)
        photos.append(UIImage(named: "ii5")!)
        photos.append(UIImage(named: "ii6")!)
        photos.append(UIImage(named: "ii9")!)
        photos.append(UIImage(named: "ii7")!)
        photos.append(UIImage(named: "ii1")!)
        photos.append(UIImage(named: "ii2")!)
        photos.append(UIImage(named: "ii3")!)
        photos.append(UIImage(named: "ii4")!)
